...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#FF6A00", "#FF6A00"};
wxString btn_confirm[10]  = {"#DFDFDF", "#E65C00", "#FF8533", "#FF6A00", "#FF6A00", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#FF6A00", "#FF8533"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#FF6A00", "#FF6A00"};
